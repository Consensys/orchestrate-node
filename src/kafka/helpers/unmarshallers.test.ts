  ...
  describe('unmarshalEnvelope', () => {
    it('should unmarshal an envelope successfully', () => {
      const expectedValue: IResponseValue = {
        ...
        jobUUID: mockTxResponse.jobUUID,
        ...
        receipt: {
          ...
          effectiveGasPrice: mockTxResponse.receipt.effectiveGasPrice,
          logs: undefined,
          bloom: mockBloom,
          postState: mockPostState,
          contractAddress: mockContractAddress,
        ...
        txContext: {
          ...
          gasTipCap: mockTxResponse.transaction.gasTipCap,
          gasFeeCap: mockTxResponse.transaction.gasFeeCap,
          txType: mockTxResponse.transaction.txType,
          value: mockValue,
          input: mockData,
          to: mockTo,
          raw: mockData,
