// Default topics
export const DEFAULT_TOPIC_WALLET_GENERATOR = 'topic-account-generator'
export const DEFAULT_TOPIC_WALLET_GENERATED = 'topic-account-generated'
export const DEFAULT_TOPIC_TX_CRAFTER = 'topic-tx-crafter'
export const DEFAULT_TOPIC_TX_SENDER = 'topic-tx-sender'
